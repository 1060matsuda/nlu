...
ax.plot(abs_ffted_data[1, 0:fu.getIndexOfNearestValue(abs_ffted_data[1], max(freq_f1*10**9, freq_f2*10**9))*4],
        abs_ffted_data[0, 0:fu.getIndexOfNearestValue(abs_ffted_data[1], max(freq_f1*10**9, freq_f2*10**9))*4],  linestyle="-", linewidth=4)
ax.set_xlabel("Freqency [Hz]")
ax.set_ylabel("Amplitude [arb.]")
ax.grid()
plt.title("Frequency spectrum")
plt.savefig("freq_spectrum_rightend_detector.svg")
